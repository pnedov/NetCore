...
{
  public class MovieBoxApiService : IGetMovies
  {
    /// <summary>
    ...
    public IMovie GetMovies(string searchRequest, int pageNumber)
    {
      // validate
      ...
      // deserialize
      IMovie result = JsonConvert.DeserializeObject<MoviesResponse>(response.Content, new JsonSerializerSettings
      {
